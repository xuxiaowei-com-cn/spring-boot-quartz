...
public class MyBatisPlusGenerator {
     ...
     * 主文件夹
     */
    private final String main = projectPath + "/src/main";

    /**
     * java 文件的路径
     */
    private final String outputDir = main + "/java";

    /**
     * XML 文件夹
     */
    private final String mapper = main + "/resources/mapper/";

    /**
     * 数据库 地址
     */
    private String url = "jdbc:p6spy:mysql://127.0.0.1:3306/spring_boot_quartz?useSSL=false&serverTimezone=GMT%2B8";
     ...
     * 代码生成器
     */
    protected void getAutoGenerator() {
...
//        <code>templateConfig.setController("/templates/controller2.java");</code>
    ...
    private PackageConfig getPackageConfig() {
        ...
        // 默认模块名
//        String moduleName = "framework";
        // 模块名
//        String moduleNameScanner = scanner("生成模块名：\n输入“f”时，使用固定模块名（" + moduleName + "）");

//        String fModuleName = "f";

//        if (fModuleName.equals(moduleNameScanner)) {
//            packageConfig.setModuleName(moduleName);
//        } else {
          //   模块名
//            packageConfig.setModuleName(moduleNameScanner);
//        }

        packageConfig.setModuleName(null);

        // 设置 父包名
        packageConfig.setParent("cn.com.xuxiaowei");
    ...
    private GlobalConfig getGlobalConfig() {
        ...
        // 设置 Controller 名
        globalConfig.setControllerName("%sRestController");
    ...
    private StrategyConfig getStrategyConfig(PackageConfig packageConfig) {
        ...
        String superEntityClass = scanner("是否使用 Entity 父类，\n输入“-”时，忽略\n输入“1”时，使用父包");

        String ignore = "-";
        String use = "1";

        // 忽略
        if (ignore.equals(superEntityClass)) {
            superEntityClass = null;
        } else if (use.equals(superEntityClass)) {
            // 自定义继承的Entity类全称，带包名
            superEntityClass = cn.com.xuxiaowei.entity.Entity.class.getName();
        }
        ...
        // <code>strategyConfig.setSuperControllerClass(superControllerClass);</code>
